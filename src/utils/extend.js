...
String.prototype.checkPassword = function () {
  ...
  if (pass.includes(' ')) throw new InvalidValueException('Password cannot contains spaces.')
  if (pass.length < 8) throw new InvalidValueException('Password must be at least 8 charactors.')
